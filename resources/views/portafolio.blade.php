...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/port.css') }}">
  </head>
          ...
          <div class="main__col-1">
            ...
            <ul class="main__list">
              ...
              <li class="main__list-item">
                ...
                <div class="main__list-content-wrap">
                  <p class="main__list-content">Angel Namar Waterfall</p>
              ...
              <li class="main__list-item">
                <div class="main__list-content-wrap">
                  <p class="main__list-content">Angel Hanifah</p>
